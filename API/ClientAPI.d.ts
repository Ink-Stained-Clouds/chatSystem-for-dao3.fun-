...
/**
 * 因神岛平台限制，无法使用Nodejs原生模块
 * 这里是模拟 Node.js 的 process 对象
 */
declare const process: {
  /**
   * 返回一个包含用户环境信息的对象。
   * 需结合插件dotenv-webpack使用。
   * @link https://docs.box3lab.com/arenapro/guide/six/env.html
   */
  env: {
...
declare class ClientRemoteChannel {
  /**
   * 向服务端发送数据。
   * @link https://docs.box3lab.com/arenapro/difference/remoteChannel.html
   */
...
declare class UiNode {
   ...
   * @param name - 子节点名称。
   * @link https://docs.box3lab.com/arenapro/difference/findChildByName.html
   */
